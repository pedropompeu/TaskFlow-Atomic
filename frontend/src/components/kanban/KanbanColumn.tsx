  ...
  return (
    <div className="flex flex-col w-72 shrink-0">
      ...
      <div
        ref={setNodeRef}
        className={cn(
          'flex-1 min-h-[120px] bg-white/40 backdrop-blur-sm rounded-b-xl border border-atomic-gray-300/40 p-2 space-y-2',
          'transition-all duration-200',
          isOver && 'bg-atomic-orange/8 border-atomic-orange/40 shadow-[inset_0_0_20px_rgba(247,142,47,0.08)]',
        )}
      >
